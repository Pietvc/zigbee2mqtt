class MyExampleExtension1640687144372 {
    constructor(zigbee, mqtt, state, publishEntityState, eventBus, settings, logger) {
        logger.info('Loaded  MyExampleExtension1640687144372');
        mqtt.publish('example/extension', 'hello from MyExampleExtension1640687144372');
...
module.exports = MyExampleExtension1640687144372;
